...
# ---------- Configuration ----------
environment = os.getenv("ENVIRONMENT", "beta")      # “beta” by default
...
# --- Initial single‑file upload (optional seed file) ---
input_path = "./audio_inputs/project_audio-2.mp3"
s3_input_key = f"{environment}/audio_inputs/project_audio-2.mp3"
...
translation_key = (
    f"{environment}/translations/{base_filename}_{target_language_code}.txt"
)
